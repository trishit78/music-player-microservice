...
const Admin = () => {
    ...
    const [descripition,setDescription] = useState<string>("");
    ...
    const addAlbumHandler = async (e: FormEvent) => {
        ...
        formData.append("descriptions", descripition);
    ...
    <div className="min-h-screen bg-[#212121] text-white p-8 ">
      ...
      <form className="bg-[#181818] p-6 rounded-lg shadow-lg flex flex-col items-center justify-center gap-4" onSubmit={addAlbumHandler}>
        ...
        required
        />
        <input type="file" placeholder="Choose Thumbnail" onChange={fileChangeHandler} className="auth-input" accept="image/*" required  />
      ...
      <form className="bg-[#181818] p-6 rounded-lg shadow-lg flex flex-col items-center justify-center gap-4" onSubmit={addSongHandler}>
        ...
        <input type="file" placeholder="Choose Audio" onChange={fileChangeHandler} className="auth-input" accept="audio/*" required  />
